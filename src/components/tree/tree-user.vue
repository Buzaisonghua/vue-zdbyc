      ...
      <a-col :span="12">
        <div class="tree_left">
          ...
          <div class="tree_search">
            <a-input-search v-model="tree_searchVal" placeholder="请输入人员名称" @change="tree_search" />
          </div>
          <a-tree
            class="tree"
          ...
          >
            ...
            <svg-icon slot="tree-user" icon-class="tree-user" style="font-size:16px" />
          </a-tree>
        </div>
      </a-col>
        ...
        <div class="tree_right">
          ...
          <ul class="tree_resultList">
            <li v-for="(item, i) in tree_resultList" :key="i">
              ...
              <!-- <svg-icon v-else icon-class="tree-district" slot="tree-district" style="font-size:16px" /> -->
              <svg-icon v-else slot="tree-user" icon-class="tree-user" style="font-size:16px" />
              {{ item.croatTitle }}
            </li>
          </ul>
        </div>
...
export default {
  ...
  created() {
    this.croatUuid = this.users.strMap.orgUuid
    this.fetchData()
  },
  methods: {
    tree_handleOk() {
